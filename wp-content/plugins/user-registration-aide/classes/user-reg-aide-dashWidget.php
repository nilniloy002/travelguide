...
class URA_DASHBOARD_WIDGET
{
	...
	*/
	...
	function update_dashboard_widget_options(){
		...
		update_option( 'csds_userRegAide_Options', $update );
		$msg = '<div class="updated"><p>'. __( 'Dashboard Widget Fields Display Option Updated Successfully!', 'csds_userRegAide' ) .'</p></div>';
	...
	*/
	...
	function update_dashboard_widget_fields(){
		...
		if($errors == 0){
			$msg = '</div><div class="updated"><p>'. __( 'Dashboard Widget Fields Updated Successfully!', 'csds_userRegAide' ) .'</p></div>';					//Report to the user that the data has been updated successfully
		}else{
			$msg = '</div><div class="updated"><p>'. __( $err_message, 'csds_userRegAide' ) .'</p></div>';
			//exit();
		} // end if
		if( !empty( $msg ) ){
			return $msg;
	...
	*/
	...
	function update_dashboard_widget_field_order(){
		...
		if( $errors == 0 ){
			$msg = '</div><div class="updated"><p>'. __( 'Dashboard Widget Fields Order Updated Successfully!', 'csds_userRegAide' ) .'</p></div>';					//Report to the user that the data has been updated successfully
		}else{
			$msg = '</div><div class="error"><p>'. __( $err_message, 'csds_userRegAide' ) .'</p></div>';
			//exit();
		} // end if
		return $msg;
	}
