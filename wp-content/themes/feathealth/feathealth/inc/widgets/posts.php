...
class Posts extends WP_Widget 
{
        	...
        	<?php
				...
				foreach($posts as $p) {?>
                    <li>
						...
						?>
						<div class='clear before-meta'></div>
						<span class='post-author'>Posted by <?php echo get_userdata( $p->post_author )->display_name; ?></span>
						<span class='date'><span class='day'><?php echo get_the_time( 'F j, Y' ); ?></span></span>
    ...
    {	
        ...
        <div class="tt-widget">
            <table width="100%">
                <tr>
                    <td class="tt-widget-label" width="25%"><label for="<?php echo $this->get_field_id('title',$p->ID); ?>">Title:</label></td>
